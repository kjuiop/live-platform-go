...
`live-platform-go`는 **실시간 채팅 시스템**을 위한 서버 애플리케이션으로, Kafka와 WebSocket을 활용하여 확장성 있는 채팅 서비스 구축을 목표로 합니다.
...
- 서버가 사용자로부터 WebSocket 메시지를 받으면 이를 Kafka 브로커에 Publish 합니다.
